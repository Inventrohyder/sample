...
import { useButtonOpacityAnimation } from "../../hooks/useButtonOpacityAnimation";
...
export function NavigationControls({
  ...
  // Animate button opacity based on enabled/disabled state
  const { nextButtonOpacity, previousButtonOpacity } =
    useButtonOpacityAnimation(canGoNext, canGoPrevious);
